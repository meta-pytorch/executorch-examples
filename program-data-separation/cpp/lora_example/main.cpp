...
DEFINE_string(model1, "qwen3_06B_lora.pte",
              "First model (with LoRA), a PTE file.");
DEFINE_string(model2, "qwen3_06B.pte",
              "Second model (without LoRA), a PTE file.");
DEFINE_string(weights1, "qwen3_06B.ptd,qwen3_06B_lora.ptd",
              "Comma-separated weights for model1 (foundation + LoRA PTD files).");
DEFINE_string(weights2, "qwen3_06B.ptd",
              "Weights for model2 (foundation PTD file).");
